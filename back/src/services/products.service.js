...
exports.getProductsByCategoryIdService = exports.getProductsByIdService = exports.getProductsService = exports.checkProductExists = void 0;
...
const getProductsByIdService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield product_repository_1.ProductRepository.findOneBy({ id: Number(id) });
});
exports.getProductsByIdService = getProductsByIdService;
const getProductsByCategoryIdService = (categoryId) => __awaiter(void 0, void 0, void 0, function* () {
    if (categoryId === 'all') {
        return (0, exports.getProductsService)();
    }
    return yield product_repository_1.ProductRepository.find({
        where: {
...
exports.getProductsByCategoryIdService = getProductsByCategoryIdService;
